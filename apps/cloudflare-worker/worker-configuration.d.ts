/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=preview --strict-vars=false` (hash: aacd9ae8cb329918b78be2ac1c6cbfad)
...
interface __BaseEnv_Env {
	...
	ANONYMOUS_MAX_AUDIO_DURATION_MS: string;
	FREE_TIER_GUARD_LEVEL: string;
	QUOTA_EXEMPT_ACCOUNT_EMAILS: string;
	ADMIN_ACCOUNT_EMAILS: string;
	OPENAI_STT_URL: string;
	OPENAI_STT_MODEL: string;
	TURNSTILE_SITE_KEY: string;
	ANALYSIS_WORKFLOW: Workflow<Parameters<import("./src/index").SpeechAnalysisWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_VERSION" | "RESOURCE_NAMESPACE" | "STORAGE_PROVIDER" | "ALLOWED_ORIGINS" | "SUPABASE_URL" | "SUPABASE_STORAGE_BUCKET" | "STORAGE_LIMIT_BYTES" | "PAYMENTS_ENABLED" | "MAX_AUDIO_BYTES" | "MAX_AUDIO_DURATION_MS" | "ANONYMOUS_MAX_AUDIO_DURATION_MS" | "FREE_TIER_GUARD_LEVEL" | "QUOTA_EXEMPT_ACCOUNT_EMAILS" | "ADMIN_ACCOUNT_EMAILS" | "OPENAI_STT_URL" | "OPENAI_STT_MODEL" | "TURNSTILE_SITE_KEY">> {}
}
