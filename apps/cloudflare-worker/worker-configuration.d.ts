/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=preview --strict-vars=false` (hash: 8ddc6fd62f0ad4b3a7849525a1538360)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_VERSION" | "RESOURCE_NAMESPACE" | "STORAGE_PROVIDER" | "ALLOWED_ORIGINS" | "SUPABASE_URL" | "SUPABASE_STORAGE_BUCKET" | "STORAGE_LIMIT_BYTES" | "PAYMENTS_ENABLED" | "MAX_AUDIO_BYTES" | "MAX_AUDIO_DURATION_MS" | "ANONYMOUS_MAX_AUDIO_DURATION_MS" | "FREE_TIER_GUARD_LEVEL" | "OPENAI_STT_URL" | "OPENAI_STT_MODEL" | "TURNSTILE_SITE_KEY">> {}
}
